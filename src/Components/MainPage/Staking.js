...
import luminaLogo from "./sonar.jpg";
import bluediamond from "./bluediamond.jpg";
...
export const Staking = ({ connected }) => {
  ...
  const [symbol, setSymbol] = useState("FINDR");
  ...
  const [tokenAddress, setTokenAddress] = useState(
    "0xaA17e4F57A67422736A1dE0fF0aF29ab0873e39a"
  );
    ...
    <Div w="100vw" h="100vh" d="flex" align="center" justify="center">
      ...
      <Div
        ...
        <Div
          m={{ x: "0.25rem" }}
          tag="a"
          href="https://t.me/+f_naXO1nle4wMzZh/">
          <svg
        ...
        <Div m={{ x: "0.25rem" }} tag="a" href="https://twitter.com/Lumina__X/">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            width="22"
            height="22"
        ...
        <Div m={{ x: "0.25rem" }} tag="a" href="https://luminax.info/">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            width="22"
            height="22"
